...
// Nice work! Very solid start on inPigLatin!
...
function pigWordConsonant(word) { //this is not working correctly....
    ...
    for (let i = 0; i < word.length; i++) {
        ...
        if (vowels.includes(pigChar)) {
            ...
            // Close, however this is concatenating in the wrong order, we need to use
            // the pattern
            //
            // return word.slice(i) + word.slice(0, i) + 'ay'; // -AZ
        }
    }
}
...
// Very strong start to inPigLatin. This is indeed a difficult problem, but you decomposed
// it very well. If given a complex problem like this on an interview, this is exactly
// what you should do! Start decomposing it and show them your thought process!
//
// See my comments above on how to fix `pigWordConsonant`.
//
// After making those changes, work on the correct capitalization. -AZ
